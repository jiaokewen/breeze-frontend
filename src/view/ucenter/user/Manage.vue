<template>
<div>
  <Modal v-model="modal1" title="用户信息" width="35" :mask-closable='false'>
  ...
  <manage-table :data="data" :total="total" :currentPage="currentPage"
    @view="view" @edit="edit" @pageChange="pageChange" @del="del" :loading="tableLoading">
  </manage-table>
</div>
</template>
